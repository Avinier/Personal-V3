...
const TweetEmbedContainer = () => {
  const tweetEmbeds = [
    ...
    '<blockquote class="twitter-tweet"><p lang="en" dir="ltr">quantum mechanics is &quot;if it works don&#39;t touch it&quot; type shit</p>&mdash; Avinier 🐉 (@avinierx) <a href="https://twitter.com/avinierx/status/1845088774583353349?ref_src=twsrc%5Etfw">October 12, 2024</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>',
    '<blockquote class="twitter-tweet"><p lang="en" dir="ltr">I love judo I love to break my body 3 times a week I love to engage my mind in the physical chess I&#39;m never gonna quit it again</p>&mdash; Avinier 🐉 (@avinierx) <a href="https://twitter.com/avinierx/status/1845873193627889674?ref_src=twsrc%5Etfw">October 14, 2024</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>',
    '<blockquote class="twitter-tweet"><p lang="en" dir="ltr">I&#39;m taking an oath. From this day, in every meaningful conversation that I&#39;m a part of, I will never fail to mention Elon Musk and his greatness. Be it tech or nontech, frnds or family, I will always utter his name, with great respect that too, and defend him come what may. ⚔️🛐 <a href="https://t.co/KcxeFrmVz2">https://t.co/KcxeFrmVz2</a></p>&mdash; Avinier 🐉 (@avinierx) <a href="https://twitter.com/avinierx/status/1845448718817833264?ref_src=twsrc%5Etfw">October 13, 2024</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>'
  ];
